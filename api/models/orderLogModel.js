...
var orderLogSchema = new Schema ({
  ...
  code:{ //what happened
    ...
    'stowage_not_ready','stowage_ready','address_pickup_start','address_pickup_accepted','address_pickup','address_delivery_not_ready', 'group_address_pickup_accepted',
		'accepted', 'inProgress', 'done', 'driver_pickup_box_address', 'received', 'operator_edit'],
